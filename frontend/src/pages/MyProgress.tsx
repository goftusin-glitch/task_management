...
import { getMyProgress, updateTask } from '../api/tasks';
import {
    Box,
    Typography,
    Button,
    ...
    return (
        <Box>
            ...
            <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
                Showing tasks that are currently in progress
            </Typography>
            ...
            <Paper elevation={0} sx={{ border: '1px solid', borderColor: 'divider' }}>
                {tasks.length === 0 ? (
                    <Box sx={{ textAlign: 'center', py: 8, px: 3 }}>
                        ...
                        <Typography variant="h6" color="text.secondary">No tasks in progress</Typography>
                        <Typography variant="body2" color="text.secondary">Tasks that are in progress will appear here</Typography>
                    </Box>
                ) : (
                    <TableContainer>
                        <Table>
